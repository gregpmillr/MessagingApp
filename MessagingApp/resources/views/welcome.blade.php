...
@section('welcome')
    ...
    <div class="inner cover">
        <p class="lead">
            <a href="#features" class="btn btn-lg btn-default main animation-element slide-left animation-button-1">Check it out!</a>
        </p>
    </div>
@endsection
    ...
    <div class="container marketing" id="features">
        ...
        <div class="row voffset6">
            ...
            <div class="col-lg-4">
                ...
                <p><a class="btn btn-lg btn-success" href="{{ url('/auth/register') }}" role="button">Sign me up!</a></p>
            </div>
